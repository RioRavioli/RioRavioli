...
/**
 * This class, along with HW7TestDriver, can be used to test your Campus Paths
 ...
 * In this case, it will create one HW7TestDriver instance per .expected file,
...
public class ScriptFileTests {
    ...
    private String runScriptFile() throws IOException {
        ...
        HW7TestDriver td = new HW7TestDriver(testScriptFile, actual);
        td.runTests();
