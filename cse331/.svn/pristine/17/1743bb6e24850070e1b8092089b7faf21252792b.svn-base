...
public final class RatPolyStack implements Iterable<RatPoly> {
    ...
    public void dup() {
		 ...
		 RatPoly newPoly = poly.mul(new RatPoly(1, 0));
		 polys.push(newPoly);
    ...
    public void add() {
		 RatPoly poly1 = polys.pop();
		 RatPoly poly2 = polys.pop();
		 RatPoly newPoly = poly1.add(poly2);
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
    ...
    public void sub() {
		 RatPoly poly1 = polys.pop();
		 RatPoly poly2 = polys.pop();
		 RatPoly newPoly = poly2.sub(poly1);
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
    ...
    public void mul() {
		 RatPoly poly1 = polys.pop();
		 RatPoly poly2 = polys.pop();
		 RatPoly newPoly = poly1.mul(poly2);
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
    ...
    public void div() {
		 RatPoly poly1 = polys.pop();
		 RatPoly poly2 = polys.pop();
		 RatPoly newPoly = poly2.div(poly1);
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
    ...
    public void differentiate() {
		 ...
		 RatPoly newPoly = poly.differentiate();
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
    ...
    public void integrate() {
		 RatPoly poly = polys.pop();
		 RatPoly newPoly = poly.antiDifferentiate(new RatNum(0));
		 polys.push(newPoly);
        // TODO: Fill in this method, then remove the RuntimeException
