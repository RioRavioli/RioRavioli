...
.: "FT PUREWHITE" THEME LICENSE :.


This theme contains copyrighted material.  The author of this theme (info@stefrosselli.com, the "Author") reserves all applicable rights under law.
You may not use this theme except in compliance with the following terms.
...
You may use this theme on a personal, non-commercial basis only, subject to the following restrictions, and further subject to exceptions listed in following sections.
...
.: IMAGES COPIED FROM THE DEFAULT FIREFOX THEME


Images copied from the default Firefox theme are not restricted by this license.
Use of these images may be subject to license terms imposed by the Mozilla Corporation.
For more information see http://www.mozilla.com .
...
Except as specifically allowed above, all rights reserved.
...
This theme and all of its contents are distributed on an "AS IS" basis,
