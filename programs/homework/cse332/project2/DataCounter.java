 ...
 * 
 * Although you will be using this interface only with Strings, we have 
 * made the code generic and your data structures will follow the "function object"
 * approach.  This approach is important when you do HashTable, because you need
 * to implement your own hashcode using a Hasher object.
 *
